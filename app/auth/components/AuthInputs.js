    ...
    <>
      {user.loading ? (
        ...
        <div className={`${isMatchMD ? "w-[80%]" : "w-[50%]"} p-1 bg-white`}>
          <div className="py-[5vh] w-full h-full flex flex-col border-4 border-[#FFBD59] [&>*]:w-[80%] [&>*]:mx-auto [&>*]:mb-4 [&>input]:border [&>input]:border-[#DAD8D3] [&>input]:rounded-sm [&>input]:p-2">
            ...
            <Link
              href="#"
              className="text-[#FFBD59] p-[1px] rounded-md border px-4 py-2 bg-black boder hover:border-[#E88F08] hover:text-black hover:bg-white font-bold text-center"
            >
              Tạo tài khoản mới
            </Link>
